        ...
        <div className="container">
          ...
          <div className="row mt-50">
            <div className="content">
              ...
              <p>Overall, our extensive global distribution network enables us to efficiently and effectively deliver biosamples to researchers Countrywide, fostering collaborations and accelerating scientific advancements on a global scale.</p>
