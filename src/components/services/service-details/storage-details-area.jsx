        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-12">
              ...
              >
                <img
                  src="/assets/img/banner/laboratory-and-biobank.jpg"
                  alt={"services-thumb"}
                />
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="tp-srv-research mb-50">
                <h4 className="text-center tp-srv-research__title mb-25">Our facilities can store a wide array of biosamples including (we are adding more)</h4>
                <figure>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="tp-srv-stap mb-40">
                <h4 className="tp-srv-stap__title mb-25" style={{textTransform: "uppercase"}}>We provide perfect temperatures of storage environments as</h4>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="tp-srv-stap mb-40">
                <h4 className="tp-srv-stap__title mb-25">Storage in Data</h4>
                <p>
                ...
                <div className="mt-30">
                  <img src="/assets/img/services/storageData.png" alt={'storage data'} width={'100%'} />
                </div>
                <h4 className="tp-srv-stap__title mt-25">Client Integration and data management</h4>
                <p>
                ...
                <h4 className="tp-srv-stap__title mt-25">LIMS and Cloud System</h4>
...
export default Storage02DetailsArea;
